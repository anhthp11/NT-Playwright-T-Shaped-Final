...
> 31 |     expect(submittedData).toEqual ({
  ...
  36 |         subjects: studentData.subjects.join(', '),
  37 |         hobbies: studentData.hobbies.join(', '),
  38 |         address: studentData.address,
  39 |         stateAndCity: `${studentData.state} ${studentData.city}`,
  40 |     });
